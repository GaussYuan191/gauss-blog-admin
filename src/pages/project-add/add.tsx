...
import { iconType, peojectIcon } from './config';
import './index.scss';
      ...
      <Form onFinish={handleSubmit} layout="horizontal" {...formItemLayout} className="addProject">
        ...
        <Form.Item label="项目描述" rules={[{ required: true, message: '请填写项目描述!' }]}>
          <Input
            ...
            placeholder="请填写项目描述"
            onChange={(e) => inputChange('descript', e)}
          />
        </Form.Item>
        <Form.Item label="浏览地址" rules={[{ required: true, message: '请填写项目浏览地址!' }]}>
          <Input
            value={state.view}
            placeholder="请填写项目浏览地址"
            onChange={(e) => inputChange('view', e)}
          />
        </Form.Item>
        <Form.Item
          label="github地址"
        ...
        >
          <Input
            value={state.github}
            placeholder="请填写项目github地址"
            onChange={(e) => inputChange('github', e)}
          />
        </Form.Item>
        <Form.Item label="项目图标" rules={[{ required: true, message: '请填icon!' }]}>
          <Radio.Group value={state.icon} onChange={(e) => inputChange('icon', e)}>
            {peojectIcon.map((icon: iconType) => (
              <Radio.Button value={icon.class} key={icon.class}>
